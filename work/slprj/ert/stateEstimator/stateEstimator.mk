...
## Generated on : Wed Nov 06 18:11:12 2024
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/slprj/ert/stateEstimator -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(START_DIR)/slprj/ert/_sharedutils -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2023a/toolbox/target/SUPPOR~1/parrot/include -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils
...
stateEstimator.o : $(START_DIR)/slprj/ert/stateEstimator/stateEstimator.c
	$(CC) $(CFLAGS) -o "$@" "$<"
