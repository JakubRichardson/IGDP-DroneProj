 ...
 * C/C++ source code generated on : Thu Nov 14 14:30:45 2024
 *
  ...
  P_MeasurementUpdate_stateEstimator_T *localP)
{
  ...
  if (rtu_Enable) {
    ...
    rty_Lykyhatkk1[0] = rtu_Lk[0] * rtu_yk_idx_0 + rtu_Lk[2] * rtu_yk_idx_1;
    rty_Lykyhatkk1[1] = rtu_Lk[1] * rtu_yk_idx_0 + rtu_Lk[3] * rtu_yk_idx_1;
  ...
  *localDW, P_EnabledSubsystem_stateEstimator_T *localP)
{
  ...
  if (rtu_Enable) {
    ...
    rty_deltax[0] = rtu_Mk[0] * rtu_yk_idx_0 + rtu_Mk[2] * rtu_yk_idx_1;
    rty_deltax[1] = rtu_Mk[1] * rtu_yk_idx_0 + rtu_Mk[3] * rtu_yk_idx_1;
  ...
  arg_sensorCalibration_datin[8])
{
  ...
  stateEstimator_DW.IIR_IMUgyro_r_tmp = rtb_DataTypeConversion1_idx_0 /
   ...
   */
  stateEstimator_B.rtb_DataTypeConversion1_idx_1 =
    stateEstimator_P_g.gyro_sensitivity_Gain * stateEstimator_B.sincos_o1[1] +
    stateEstimator_B.rtb_sincos_o2_idx_1;

  /* DiscreteFir: '<S5>/FIR_IMUaccel' */
  stateEstimator_B.rtb_sincos_o2_idx_1 = stateEstimator_B.inverseIMU_gain[0] *
  ...
  stateEstimator_B.FIR_IMUaccel[0] = stateEstimator_B.rtb_sincos_o2_idx_1;

  /* Math: '<S2>/Math Function' incorporates:
   *  Constant: '<S2>/Constant'
   *  DiscreteFir: '<S5>/FIR_IMUaccel'
   */
  rtb_DataTypeConversion1_idx_0 = (real32_T)floor
    (stateEstimator_P_g.Constant_Value_n);
  if ((stateEstimator_B.rtb_sincos_o2_idx_1 < 0.0F) &&
      (stateEstimator_P_g.Constant_Value_n > rtb_DataTypeConversion1_idx_0)) {
    y = -rt_powf_snf(-stateEstimator_B.rtb_sincos_o2_idx_1,
                     stateEstimator_P_g.Constant_Value_n);
  } else {
    y = rt_powf_snf(stateEstimator_B.rtb_sincos_o2_idx_1,
                    stateEstimator_P_g.Constant_Value_n);
  ...
  stateEstimator_B.FIR_IMUaccel[1] = stateEstimator_B.rtb_sincos_o2_idx_1;
  ...
  if ((stateEstimator_B.rtb_sincos_o2_idx_1 < 0.0F) &&
      (stateEstimator_P_g.Constant_Value_n > rtb_DataTypeConversion1_idx_0)) {
    stateEstimator_B.sincos_o1[1] = -rt_powf_snf
      (-stateEstimator_B.rtb_sincos_o2_idx_1,
       stateEstimator_P_g.Constant_Value_n);
  } else {
    stateEstimator_B.sincos_o1[1] = rt_powf_snf
      (stateEstimator_B.rtb_sincos_o2_idx_1, stateEstimator_P_g.Constant_Value_n);
  }
  ...
  stateEstimator_B.FIR_IMUaccel[2] = stateEstimator_B.rtb_sincos_o2_idx_1;
  ...
  if ((stateEstimator_B.rtb_sincos_o2_idx_1 < 0.0F) &&
      (stateEstimator_P_g.Constant_Value_n > rtb_DataTypeConversion1_idx_0)) {
    rtb_DataTypeConversion1_idx_0 = -rt_powf_snf
      (-stateEstimator_B.rtb_sincos_o2_idx_1,
       stateEstimator_P_g.Constant_Value_n);
  } else {
    rtb_DataTypeConversion1_idx_0 = rt_powf_snf
   ...
   */
  rtb_DataTypeConversion1_idx_0 = (real32_T)sqrt((y +
    stateEstimator_B.sincos_o1[1]) + rtb_DataTypeConversion1_idx_0);
   ...
   */
  if ((rtb_DataTypeConversion1_idx_0 >
    ...
    } else if (stateEstimator_B.rtb_sincos_o2_idx_0 < -1.0F) {
      stateEstimator_B.rtb_sincos_o2_idx_0 = -1.0F;
    }
     ...
     *  Trigonometry: '<S8>/Trigonometric Function1'
     */
    stateEstimator_B.Merge[0] = stateEstimator_P_g.Gain4_Gain *
      stateEstimator_B.rtb_DataTypeConversion1_idx_1 +
      stateEstimator_P_g.Gain3_Gain * (real32_T)asin
     ...
     *  Gain: '<S2>/gyro_sensitivity'
     *  Memory: '<S2>/Memory'
     *  SignalConversion generated from: '<S10>/prin'
     *  SignalConversion generated from: '<S12>/Trigonometric Function'
     *  Sum: '<S2>/Sum'
     */
    stateEstimator_B.Merge[0] = stateEstimator_B.rtb_DataTypeConversion1_idx_1;
    stateEstimator_B.Merge[1] = stateEstimator_P_g.gyro_sensitivity_Gain *
      stateEstimator_B.sincos_o1[2] + stateEstimator_DW.Memory_PreviousInput[2];
  ...
  stateEstimator_B.rtb_sincos_o2_idx_0 = (real32_T)cos
    (stateEstimator_DW.Memory_PreviousInput[0]);
  rtb_DataTypeConversion1_idx_0 = (real32_T)sin
    (stateEstimator_DW.Memory_PreviousInput[1]);
  stateEstimator_B.rtb_DataTypeConversion1_idx_1 = (real32_T)cos
    (stateEstimator_DW.Memory_PreviousInput[1]);
   ...
   */
  rtb_VectorConcatenate_tmp = stateEstimator_B.rtb_sincos_o2_idx_0 *
    stateEstimator_B.rtb_DataTypeConversion1_idx_1;
   ...
   *  Trigonometry: '<S16>/sincos'
   */
  rtb_VectorConcatenate_tmp_tmp = rtb_DataTypeConversion1_idx_0 * y;
  rtb_VectorConcatenate_tmp_0 = stateEstimator_B.rtb_sincos_o2_idx_2 *
    rtb_sincos_o2_idx_2_tmp;
  stateEstimator_B.VectorConcatenate[1] = rtb_VectorConcatenate_tmp_tmp *
    stateEstimator_B.rtb_sincos_o2_idx_0 - rtb_VectorConcatenate_tmp_0;
   ...
   *  Trigonometry: '<S16>/sincos'
   */
  rtb_VectorConcatenate_tmp_tmp_0 = rtb_DataTypeConversion1_idx_0 *
    rtb_sincos_o2_idx_2_tmp;
  rtb_VectorConcatenate_tmp_1 = stateEstimator_B.rtb_sincos_o2_idx_2 * y;
  stateEstimator_B.VectorConcatenate[2] = rtb_VectorConcatenate_tmp_tmp_0 *
    stateEstimator_B.rtb_sincos_o2_idx_0 + rtb_VectorConcatenate_tmp_1;
   ...
   *  Trigonometry: '<S16>/sincos'
   */
  rtb_VectorConcatenate_tmp_2 = stateEstimator_B.rtb_sincos_o2_idx_2 *
    stateEstimator_B.rtb_DataTypeConversion1_idx_1;
   ...
   *  Trigonometry: '<S16>/sincos'
   */
  rtb_VectorConcatenate_tmp_3 = stateEstimator_B.rtb_sincos_o2_idx_0 *
    rtb_sincos_o2_idx_2_tmp;
  stateEstimator_B.VectorConcatenate[4] = rtb_VectorConcatenate_tmp_tmp *
    stateEstimator_B.rtb_sincos_o2_idx_2 + rtb_VectorConcatenate_tmp_3;
   ...
   *  Trigonometry: '<S16>/sincos'
   */
  rtb_VectorConcatenate_tmp_4 = stateEstimator_B.rtb_sincos_o2_idx_0 * y;
  stateEstimator_B.VectorConcatenate[5] = rtb_VectorConcatenate_tmp_tmp_0 *
    stateEstimator_B.rtb_sincos_o2_idx_2 - rtb_VectorConcatenate_tmp_4;
   ...
   *  Trigonometry: '<S16>/sincos'
   */
  stateEstimator_B.rtb_DataTypeConversion1_idx_1 *= rtb_sincos_o2_idx_2_tmp;
  ...
  /* Fcn: '<S80>/Fcn13' */
  stateEstimator_B.Reshape9to3x3columnmajor[6] = -rtb_DataTypeConversion1_idx_0;
  ...
  /* Fcn: '<S151>/Fcn13' */
  stateEstimator_B.MathFunction_b[6] = -rtb_DataTypeConversion1_idx_0;
  ...
  for (stateEstimator_B.cff = 0; stateEstimator_B.cff < 2; stateEstimator_B.cff
    ...
    stateEstimator_B.rtb_sincos_o2_idx_2 = rtb_DataTypeConversion1_idx_0 /
      stateEstimator_P_g.IIRgyroz_DenCoef[0];
    stateEstimator_DW.IIRgyroz_tmp[stateEstimator_B.cff] =
      stateEstimator_B.rtb_sincos_o2_idx_2;
    stateEstimator_B.rtb_sincos_o2_idx_2 *= stateEstimator_P_g.IIRgyroz_NumCoef
      [0];
    stateEstimator_B.denIdx = 1;
    for (stateEstimator_B.i = 0; stateEstimator_B.i < 5; stateEstimator_B.i++) {
      stateEstimator_B.rtb_sincos_o2_idx_2 +=
     ...
     */
    stateEstimator_B.rtb_sincos_o2_idx_2 *= stateEstimator_P_g.TSamp_WtEt;
   ...
   *  Abs: '<S77>/Abs4'
   */
  rtb_DataTypeConversion1_idx_0 = (real32_T)fabs
   ...
   *  Sum: '<S77>/Add'
   */
  stateEstimator_B.LogicalOperator3 = ((((stateEstimator_B.rtb_sincos_o2_idx_0 <=
    stateEstimator_P_g.maxp_const) && (stateEstimator_B.rtb_sincos_o2_idx_2 <=
    stateEstimator_P_g.maxq_const) && (rtb_DataTypeConversion1_idx_0 <=
    ...
    ((real32_T)fabs(stateEstimator_DW.UD_DSTATE[1]) <=
     stateEstimator_P_g.maxdw2_const)) || ((rtb_DataTypeConversion1_idx_0 <=
  ...
  rtb_DataTypeConversion1_idx_0 = (real32_T)
   ...
   */
  stateEstimator_B.Sum_c = stateEstimator_P_g.gravity_Value[1];
  stateEstimator_B.unnamed_idx_0 = stateEstimator_P_g.gravity_Value[0];
  stateEstimator_B.unnamed_idx_1 = stateEstimator_P_g.gravity_Value[2];
  for (stateEstimator_B.i = 0; stateEstimator_B.i < 3; stateEstimator_B.i++) {
  ...
  if ((stateEstimator_DW.Delay_DSTATE_l[0] < 0.0F) &&
      (stateEstimator_P_g.Constant_Value_e > rtb_DataTypeConversion1_idx_0)) {
   ...
   */
  stateEstimator_B.LogicalOperator3_o = ((stateEstimator_B.rtb_sincos_o2_idx_0 <=
    stateEstimator_P_g.maxp3_const) && (stateEstimator_B.rtb_sincos_o2_idx_2 <=
   ...
   */
  stateEstimator_B.rtb_Add_j_idx_0 = stateEstimator_DW.MemoryX_DSTATE[1];
  stateEstimator_B.Sum_c = stateEstimator_DW.MemoryX_DSTATE[0];
  for (stateEstimator_B.cff = 0; stateEstimator_B.cff < 2; stateEstimator_B.cff
       ++) {
    ...
    stateEstimator_B.dv[stateEstimator_B.cff] =
      ...
      stateEstimator_B.rtb_Add_j_idx_0 +
      stateEstimator_P_g.A_Value[stateEstimator_B.cff] * stateEstimator_B.Sum_c;
  }
