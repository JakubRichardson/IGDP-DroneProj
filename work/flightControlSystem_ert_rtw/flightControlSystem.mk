...
## Generated on : Sun Nov 10 22:42:57 2024
...
INCLUDES_BUILDINFO = -I$(START_DIR)/slprj/ert/stateEstimator -I$(START_DIR)/slprj/ert/flightController -I$(START_DIR)/slprj/ert/conversionYUV -I$(START_DIR) -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2023a/toolbox/target/SUPPOR~1/parrot/include -I$(START_DIR)/flightControlSystem_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/vision/include -I$(MATLAB_ROOT)/toolbox/shared/dsp/vision/matlab/include -I$(START_DIR)/slprj/ert/_sharedutils -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils
...
OBJS = grabberCannon.o rt_logging.o flightControlSystem.o flightControlSystem_data.o rsedu_control.o rsedu_of.o rsedu_vis.o ptimer.o controlCommand.o mw_extrathreads.o
