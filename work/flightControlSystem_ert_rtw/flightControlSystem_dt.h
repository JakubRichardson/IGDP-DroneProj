 ...
 * C source code generated on : Mon Nov 25 14:51:39 2024
 *
...
static uint_T rtDataTypeSizes[] = {
  ...
  sizeof(struct_ZvEH7nCKB8L7wECWUhdZ7E),
  sizeof(struct_p3FXZIgqtjF2uqDpmYjb6C),
  sizeof(struct_COfZm21dTKf7TGOAGwZl7F),
...
static DataTypeTransition rtBTransitions[] = {
  ...
  { (char_T *)(&flightControlSystem_B.FlightControlSystem.controller_o2[0]), 1,
    0, 8 },

  { (char_T *)(&flightControlSystem_B.FlightControlSystem.grabberState), 0, 0, 4
  },

  { (char_T *)(&flightControlSystem_B.FlightControlSystem.Abs[0]), 1, 0, 3 },

  { (char_T *)(&flightControlSystem_B.FlightControlSystem.x_c), 1, 0, 11 },
...
static DataTypeTransition rtPTransitions[] = {
  ...
  { (char_T *)(&flightControlSystem_P.RateTransition_3_InitialCondition), 8, 0,
    1 },
  ...
  { (char_T *)(&flightControlSystem_P.FlightControlSystem.Delay_InitialCondition),
    0, 0, 1 },
